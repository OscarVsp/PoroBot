...
class Moderator(commands.Cog):
    ...
    async def clearMessage(self, inter : disnake.ApplicationCommandInteraction,
        nombre : int = commands.Param(
            description = "le nombre de message à supprimer",
            gt = 0
        )
    ):
        confirm : FS.ConfirmationReturnData = await FS.confirmation(inter,
    ...
    async def clearCat(self, inter : disnake.ApplicationCommandInteraction,
    ...
    async def embed_guild(self, inter : disnake.ApplicationCommandInteraction,
    ...
    async def embed_private(self, inter : disnake.ApplicationCommandInteraction,
