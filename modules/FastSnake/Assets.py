...
class Emotes:
    ...
    A_ARROWS_DOWN: str = "<a:utility_bottompage:1009104348296519690>"
    A_ARROWS_UP: str = "<a:utility_toppage:1009104349798084759>"
    ARROWS_DOWN: str = "<:arrowdown:1031835138235056168>"
    ARROWS_UP: str = "<:arrowup:1031835139594002432>"
